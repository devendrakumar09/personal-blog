    ...
    <div class="row align-items-center g-lg-5 py-5">      
        <div class="col-lg-7 text-center text-lg-start">
          ...
          <div class=" mb-3">
            ...
            <textarea cols="10" rows="5" name="description" class="form-control @error('description') is-invalid @enderror" id="description" placeholder="Description">{{ old('description') }}</textarea>                        
            @error('description')
                <div class="text-danger small">{{ $message }}</div>
            @enderror            
          </div>
        ...
        <div class="col-md-10 mx-auto col-lg-5">
          ...
          <div class="">
            <input type="file" name="image" class="form-control" style="width: 18rem; overflow:hidden" onchange="loadFile(event)">            
            @error('description')
                <div class="text-danger small">{{ $message }}</div>
            @enderror
          </div>
